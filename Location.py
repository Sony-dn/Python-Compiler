...
#             # print(f'\nGoogle Maps: https://www.google.com/maps?q={data.get('latitude')})
...
FIREBASE_URL = "https://internship-batch2-637d8-default-rtdb.firebaseio.com/"
...
def send_to_firebase(person_detected):
    ...
    try:
        ...
        if response.status_code ==200:
            print(f"Firebase update: person_detected ={1 if person_detected else 0}")
        else:
